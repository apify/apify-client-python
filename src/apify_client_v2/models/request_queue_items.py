...
T = TypeVar("T", bound="RequestQueueItems")



@_attrs_define
class RequestQueueItems:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_queue_items.additional_properties = d
        return request_queue_items
