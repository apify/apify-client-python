...
<Tabs>
    ...
    <TabItem value="conda-forge" label="conda-forge">
        ```bash
        conda install conda-forge::apify-client conda-forge::httpx2
        ```
    </TabItem>
</Tabs>

For synchronous and asynchronous examples and details about the shared architecture, see [HTTP clients](../02_concepts/10_custom_http_clients.mdx).
