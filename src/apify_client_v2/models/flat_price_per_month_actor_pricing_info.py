...
from ..models.flat_price_per_month_actor_pricing_info_pricing_model import FlatPricePerMonthActorPricingInfoPricingModel
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="FlatPricePerMonthActorPricingInfo")
...
class FlatPricePerMonthActorPricingInfo:
    """ 
        Attributes:
            ...
            pricing_model (FlatPricePerMonthActorPricingInfoPricingModel):
            trial_minutes (float): For how long this Actor can be used for free in trial period
            price_per_unit_usd (float): Monthly flat price in USD
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        price_per_unit_usd = self.price_per_unit_usd
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_model = FlatPricePerMonthActorPricingInfoPricingModel(d.pop("pricingModel"))




        trial_minutes = d.pop("trialMinutes")

        price_per_unit_usd = d.pop("pricePerUnitUsd")
        ...
        flat_price_per_month_actor_pricing_info = cls(
        ...
        flat_price_per_month_actor_pricing_info.additional_properties = d
        return flat_price_per_month_actor_pricing_info
