...
#   timestamp: 2026-01-19T16:03:45+00:00
...
class Post(BaseModel):
    ...
    summary: Annotated[
        str | None,
        Field(
            examples=['Executes an Actor', 'waits for its completion', "and returns Actor's dataset items in response."]
        ),
    ] = None
    ...
    summary: Annotated[
        ...
        Field(
            examples=[
                ...
                'and returns the OUTPUT from Key-value store in response.',
            ]
        ),
    ] = None
    tags: Annotated[list[str] | None, Field(examples=[['Run Actor']])] = None
...
class CreateRequestQueueResponse(BaseModel):
    """Response containing the created request queue."""

    data: RequestQueue


class GetRequestQueueResponse(BaseModel):
    """Response containing the request queue details."""
...
class UpdateRequestQueueResponse(BaseModel):
    """Response containing the updated request queue."""
...
class Request(BaseModel):
    ...
    A unique key used for request de-duplication. Requests with the same unique key are considered identical.
    """
    url: Annotated[str, Field(examples=['https://apify.com/career'])]
    """
    The URL of the request.
    """
...
class GetListOfRequestsResponse(BaseModel):
