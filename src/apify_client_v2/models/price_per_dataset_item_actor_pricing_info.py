...
from ..models.price_per_dataset_item_actor_pricing_info_pricing_model import PricePerDatasetItemActorPricingInfoPricingModel
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="PricePerDatasetItemActorPricingInfo")
...
class PricePerDatasetItemActorPricingInfo:
    """ 
        Attributes:
            ...
            pricing_model (PricePerDatasetItemActorPricingInfoPricingModel):
            unit_name (str): Name of the unit that is being charged
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_model = PricePerDatasetItemActorPricingInfoPricingModel(d.pop("pricingModel"))
        ...
        price_per_dataset_item_actor_pricing_info = cls(
        ...
        price_per_dataset_item_actor_pricing_info.additional_properties = d
        return price_per_dataset_item_actor_pricing_info
