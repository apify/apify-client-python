...
from ...models.act_run_sync_get_dataset_items_get_response_201 import ActRunSyncGetDatasetItemsGetResponse201
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ActRunSyncGetDatasetItemsGetResponse201 | ErrorResponse | None:
    if response.status_code == 201:
        response_201 = ActRunSyncGetDatasetItemsGetResponse201.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ActRunSyncGetDatasetItemsGetResponse201 | ErrorResponse]:
    return Response(
...
) -> Response[ActRunSyncGetDatasetItemsGetResponse201 | ErrorResponse]:
...
def sync(
    ...
    *,
...
) -> ActRunSyncGetDatasetItemsGetResponse201 | ErrorResponse | None:
    """ Run Actor synchronously without input and get dataset items
    ...
    Returns:
        ActRunSyncGetDatasetItemsGetResponse201 | ErrorResponse
     """
