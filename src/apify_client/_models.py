...
#   timestamp: 2026-01-16T19:50:23+00:00
...
class RunStats(BaseModel):
    input_body_len: Annotated[int | None, Field(alias='inputBodyLen', examples=[240])] = None
    migration_count: Annotated[int | None, Field(alias='migrationCount', examples=[0])] = None
    reboot_count: Annotated[int | None, Field(alias='rebootCount', examples=[0])] = None
    restart_count: Annotated[int, Field(alias='restartCount', examples=[0])]
    resurrect_count: Annotated[int, Field(alias='resurrectCount', examples=[2])]
    mem_avg_bytes: Annotated[float | None, Field(alias='memAvgBytes', examples=[267874071.9])] = None
    mem_max_bytes: Annotated[int | None, Field(alias='memMaxBytes', examples=[404713472])] = None
    mem_current_bytes: Annotated[int | None, Field(alias='memCurrentBytes', examples=[0])] = None
    ...
    net_rx_bytes: Annotated[int | None, Field(alias='netRxBytes', examples=[103508042])] = None
    net_tx_bytes: Annotated[int | None, Field(alias='netTxBytes', examples=[4854600])] = None
    duration_millis: Annotated[int | None, Field(alias='durationMillis', examples=[248472])] = None
    run_time_secs: Annotated[float | None, Field(alias='runTimeSecs', examples=[248.472])] = None
    metamorph: Annotated[int | None, Field(examples=[0])] = None
    compute_units: Annotated[float, Field(alias='computeUnits', examples=[0.13804])]


class RunOptions(BaseModel):
    build: Annotated[str, Field(examples=['latest'])]
    timeout_secs: Annotated[int, Field(alias='timeoutSecs', examples=[300])]
    memory_mbytes: Annotated[int, Field(alias='memoryMbytes', examples=[1024])]
    disk_mbytes: Annotated[int, Field(alias='diskMbytes', examples=[2048])]
...
class RequestQueue(BaseModel):
    ...
    """
    accessed_at: Annotated[AwareDatetime, Field(alias='accessedAt', examples=['2019-12-14T08:36:13.202Z'])]
    total_request_count: Annotated[int, Field(alias='totalRequestCount', examples=[870])]
    handled_request_count: Annotated[int, Field(alias='handledRequestCount', examples=[100])]
