...
T = TypeVar("T", bound="PutItemResponseErrorError")



@_attrs_define
class PutItemResponseErrorError:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_item_response_error_error = cls(
            error=error,
        )


        put_item_response_error_error.additional_properties = d
        return put_item_response_error_error
