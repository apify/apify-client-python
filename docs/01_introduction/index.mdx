...
To enable brotli request-body compression (better than gzip, especially for large payloads), install the optional extra and [configure the compression](../02_concepts/13_compression.mdx):
