...
T = TypeVar("T", bound="CommonActorPricingInfo")
...
class CommonActorPricingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_actor_pricing_info.additional_properties = d
        return common_actor_pricing_info
