...
T = TypeVar("T", bound="AddRequestResponseData")



@_attrs_define
class AddRequestResponseData:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_request_response_data.additional_properties = d
        return add_request_response_data
