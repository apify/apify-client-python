...
T = TypeVar("T", bound="RequestQueueRequestPutBody")



@_attrs_define
class RequestQueueRequestPutBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_queue_request_put_body = cls(
            id=id,
        ...
        request_queue_request_put_body.additional_properties = d
        return request_queue_request_put_body
