...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/actor-builds/{build_id}/openapi.json".format(build_id=build_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    You can also use the [`/api/v2/act-openapi-json-get`](/api/v2/act-openapi-json-get) endpoint to get
    the OpenAPI definition for a build.
