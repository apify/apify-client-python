...
#   timestamp: 2026-04-07T12:58:39+00:00
    ...
    pricing_infos: Annotated[
        list[
            Annotated[
                ...
                Field(discriminator='pricingModel'),
            ]
        ]
        | None,
...
class Error1(BaseModel):
    ...
    type: Type | None = None
    message: Annotated[str | None, Field(examples=['Actor was not found'])] = None
...
class Error2(BaseModel):
    ...
    message: Annotated[str | None, Field(examples=['Actor version was not found'])] = None
...
class Error3(BaseModel):
    ...
    type: Type1 | None = None
    message: Annotated[str | None, Field(examples=['Environment variable was not found'])] = None
...
class Error4(BaseModel):
    ...
    message: Annotated[
        str | None, Field(examples=['Build with tag "latest" was not found. Has the Actor been built already?'])
    ] = None
...
class Error5(BaseModel):
    ...
    message: Annotated[str | None, Field(examples=['Actor build was not found'])] = None
...
class Error6(BaseModel):
    ...
    message: Annotated[
        str | None, Field(examples=['Actor run did not succeed (run ID: 55uatRrZib4xbZs, status: FAILED)'])
    ] = None
...
class Error7(BaseModel):
    ...
    message: Annotated[
        str | None, Field(examples=['Actor run exceeded the timeout of 300 seconds for this API endpoint'])
    ] = None
...
class Error8(BaseModel):
    ...
    message: Annotated[str | None, Field(examples=['Actor run was not found'])] = None
...
class OptionalRunOptions(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class CreateTaskRequest(BaseModel):
    ...
    act_id: Annotated[str, Field(alias='actId', examples=['asADASadYvn4mBZmm'])]
    name: Annotated[str, Field(examples=['my-task'])]
    options: OptionalRunOptions | None = None
...
class Error9(BaseModel):
    ...
    message: Annotated[str | None, Field(examples=['Actor was not found or access denied'])] = None
...
class Error10(BaseModel):
    ...
    message: Annotated[str | None, Field(examples=['Key-value Store was not found'])] = None
...
class Error11(BaseModel):
    ...
    type: Type9 | None = None
    message: Annotated[str | None, Field(examples=['Record was not found'])] = None
...
class Error12(BaseModel):
    ...
    type: Type9 | None = None
    message: Annotated[str | None, Field(examples=['Dataset was not found'])] = None
...
class Error13(BaseModel):
    ...
    type: Type9 | None = None
    message: Annotated[str | None, Field(examples=['Request Queue was not found'])] = None
...
class RequestDraftDelete1(BaseModel):
...
class RequestDraftDelete2(BaseModel):
    """A request that should be deleted."""
...
class RequestDraftDelete(RootModel[RequestDraftDelete1 | RequestDraftDelete2]):
    root: Annotated[RequestDraftDelete1 | RequestDraftDelete2, Field(title='RequestDraftDelete')]
    """
    A request that should be deleted.
    """


class DeletedRequest1(BaseModel):
...
class DeletedRequest2(BaseModel):
    """Confirmation of a request that was successfully deleted from a request queue."""
...
class BatchDeleteResult(BaseModel):
    ...
    processed_requests: Annotated[list[DeletedRequest1 | DeletedRequest2], Field(alias='processedRequests')]
    """
...
class Error14(BaseModel):
    ...
    type: Type9 | None = None
    message: Annotated[str | None, Field(examples=['Request was not found'])] = None
...
class ScheduleActionShort1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class ScheduleActionShort2(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class ScheduleShort(ScheduleBase):
    ...
    actions: list[Annotated[ScheduleActionShort1 | ScheduleActionShort2, Field(discriminator='type')]]
...
class ScheduleCreateAction1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
    ...
    run_options: Annotated[OptionalRunOptions | None, Field(alias='runOptions')] = None
...
class ScheduleCreateAction2(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class ScheduleCreate(BaseModel):
    ...
    title: str | None = None
    actions: list[Annotated[ScheduleCreateAction1 | ScheduleCreateAction2, Field(discriminator='type')]] | None = None
...
class ScheduleAction1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class ScheduleAction2(BaseModel):
    model_config = ConfigDict(
        extra='allow',
        populate_by_name=True,
    )
...
class Schedule(ScheduleBase):
    ...
    description: Annotated[str | None, Field(examples=['Schedule of actor ...'])] = None
    title: str | None = None
    actions: list[Annotated[ScheduleAction1 | ScheduleAction2, Field(discriminator='type')]]
