...
T = TypeVar("T", bound="RequestOperationInfo")



@_attrs_define
class RequestOperationInfo:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_operation_info.additional_properties = d
        return request_operation_info
