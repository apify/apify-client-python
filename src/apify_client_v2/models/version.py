...
class Version:
    """ 
        Attributes:
            version_number (str):  Example: 0.0.
            source_type (Any | VersionSourceType):
            build_tag (str):  Example: latest.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_type: Any | str
        if isinstance(self.source_type, VersionSourceType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source_type(data: object) -> Any | VersionSourceType:
            try:
                ...
                pass
            return cast(Any | VersionSourceType, data)

        source_type = _parse_source_type(d.pop("sourceType"))


        build_tag = d.pop("buildTag")
