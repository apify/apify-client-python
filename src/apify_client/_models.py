...
class DefaultRunOptions(BaseModel):
    ...
    timeout_secs: Annotated[float, Field(alias='timeoutSecs', examples=[3600])]
...
class RunShort(BaseModel):
    ...
    build_number: Annotated[str, Field(alias='buildNumber', examples=['0.0.2'])]
    meta: RunMeta
...
class Run(BaseModel):
    ...
    build_number: Annotated[str, Field(alias='buildNumber', examples=['0.0.36'])]
    container_url: Annotated[str, Field(alias='containerUrl', examples=['https://g8kd8kbc5ge8.runs.apify.net'])]
