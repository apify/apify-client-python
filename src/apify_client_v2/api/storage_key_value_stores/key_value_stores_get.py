...
from ...models.get_list_of_key_value_stores_response import GetListOfKeyValueStoresResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> GetListOfKeyValueStoresResponse | None:
    if response.status_code == 200:
        response_200 = GetListOfKeyValueStoresResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[GetListOfKeyValueStoresResponse]:
    return Response(
...
) -> Response[GetListOfKeyValueStoresResponse]:
...
) -> GetListOfKeyValueStoresResponse | None:
    """ Get list of key-value stores
