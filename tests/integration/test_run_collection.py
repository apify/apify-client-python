...
def test_run_collection_list_multiple_statuses_sync(apify_client: ApifyClient) -> None:
...
def test_run_collection_list_accept_date_range_sync(apify_client: ApifyClient) -> None:
    created_runs = list[Run]()
