...
T = TypeVar("T", bound="CreateScheduleActions")



@_attrs_define
class CreateScheduleActions:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_schedule_actions.additional_properties = d
        return create_schedule_actions
