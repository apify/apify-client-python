...
T = TypeVar("T", bound="GetRequestQueueResponseData")



@_attrs_define
class GetRequestQueueResponseData:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_request_queue_response_data = cls(
            id=id,
            user_id=user_id,
        ...
        get_request_queue_response_data.additional_properties = d
        return get_request_queue_response_data
