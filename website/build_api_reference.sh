...
sed -i "" "s#${PWD}/..#REPO_ROOT_PLACEHOLDER#g" docspec-dump.jsonl
...
sed -i "" "s#search_path: \[../src\]#search_path: \[./src\]#g" "${apify_shared_tempdir}/pydoc-markdown.yml"
...
sed -i "" "s#${apify_shared_tempdir}#REPO_ROOT_PLACEHOLDER#g" apify-shared-docspec-dump.jsonl
