...
from ..models.pay_per_event_actor_pricing_info_pricing_model import PayPerEventActorPricingInfoPricingModel
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.pay_per_event_actor_pricing_info_pricing_per_event import PayPerEventActorPricingInfoPricingPerEvent





T = TypeVar("T", bound="PayPerEventActorPricingInfo")
...
class PayPerEventActorPricingInfo:
    """ 
        Attributes:
            ...
            pricing_model (PayPerEventActorPricingInfoPricingModel):
            pricing_per_event (PayPerEventActorPricingInfoPricingPerEvent):
            ...
            minimal_max_total_charge_usd (float | None | Unset):
     """
    ...
    minimal_max_total_charge_usd: float | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pricing_per_event = self.pricing_per_event.to_dict()
        ...
        minimal_max_total_charge_usd: float | None | Unset
        if isinstance(self.minimal_max_total_charge_usd, Unset):
            minimal_max_total_charge_usd = UNSET
        else:
            minimal_max_total_charge_usd = self.minimal_max_total_charge_usd
        ...
        field_dict.update({
            ...
            "pricingPerEvent": pricing_per_event,
        })
        ...
        if minimal_max_total_charge_usd is not UNSET:
            field_dict["minimalMaxTotalChargeUsd"] = minimal_max_total_charge_usd
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_model = PayPerEventActorPricingInfoPricingModel(d.pop("pricingModel"))




        pricing_per_event = PayPerEventActorPricingInfoPricingPerEvent.from_dict(d.pop("pricingPerEvent"))
        ...
        def _parse_minimal_max_total_charge_usd(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        minimal_max_total_charge_usd = _parse_minimal_max_total_charge_usd(d.pop("minimalMaxTotalChargeUsd", UNSET))


        pay_per_event_actor_pricing_info = cls(
            apify_margin_percentage=apify_margin_percentage,
            created_at=created_at,
            started_at=started_at,
            pricing_model=pricing_model,
            pricing_per_event=pricing_per_event,
            notified_about_future_change_at=notified_about_future_change_at,
            notified_about_change_at=notified_about_change_at,
            reason_for_change=reason_for_change,
            minimal_max_total_charge_usd=minimal_max_total_charge_usd,
        )


        pay_per_event_actor_pricing_info.additional_properties = d
        return pay_per_event_actor_pricing_info
