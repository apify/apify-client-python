...
from ...models.actor_task_run_sync_get_dataset_items_post_body import ActorTaskRunSyncGetDatasetItemsPostBody
from ...models.actor_task_run_sync_get_dataset_items_post_response_201 import ActorTaskRunSyncGetDatasetItemsPostResponse201
...
def _get_kwargs(
    actor_task_id: str,
    *,
    body: ActorTaskRunSyncGetDatasetItemsPostBody,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ActorTaskRunSyncGetDatasetItemsPostResponse201 | ErrorResponse | None:
    if response.status_code == 201:
        response_201 = ActorTaskRunSyncGetDatasetItemsPostResponse201.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ActorTaskRunSyncGetDatasetItemsPostResponse201 | ErrorResponse]:
    return Response(
...
) -> Response[ActorTaskRunSyncGetDatasetItemsPostResponse201 | ErrorResponse]:
...
def sync(
    ...
    *,
...
) -> ActorTaskRunSyncGetDatasetItemsPostResponse201 | ErrorResponse | None:
    """ Run task synchronously and get dataset items
    ...
    Returns:
        ActorTaskRunSyncGetDatasetItemsPostResponse201 | ErrorResponse
     """
