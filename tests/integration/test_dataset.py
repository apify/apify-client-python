...
def test_dataset_should_create_public_items_expiring_url_with_params_sync(apify_client: ApifyClient) -> None:
...
def test_dataset_should_create_public_items_non_expiring_url_sync(apify_client: ApifyClient) -> None:
    created_dataset = apify_client.datasets().get_or_create(name=random_resource_name('dataset'))
...
def test_public_url_sync(api_token: str, api_url: str, api_public_url: str) -> None:
...
def test_list_items_signature_sync(apify_client: ApifyClient, test_dataset_of_another_user: TestDataset) -> None:
...
def test_iterate_items_signature_sync(apify_client: ApifyClient, test_dataset_of_another_user: TestDataset) -> None:
    dataset = apify_client.dataset(dataset_id=test_dataset_of_another_user.id)
...
async def test_dataset_should_create_public_items_expiring_url_with_params_async(
...
async def test_dataset_should_create_public_items_non_expiring_url_async(apify_client_async: ApifyClientAsync) -> None:
    created_dataset = await apify_client_async.datasets().get_or_create(name=random_resource_name('dataset'))
...
@parametrized_api_urls
async def test_public_url_async(api_token: str, api_url: str, api_public_url: str) -> None:
...
async def test_list_items_signature_async(
...
async def test_iterate_items_signature_async(
    apify_client_async: ApifyClientAsync, test_dataset_of_another_user: TestDataset
) -> None:
    dataset = apify_client_async.dataset(dataset_id=test_dataset_of_another_user.id)
...
async def test_get_items_as_bytes_signature_async(
    apify_client_async: ApifyClientAsync, test_dataset_of_another_user: TestDataset
) -> None:
    dataset = apify_client_async.dataset(dataset_id=test_dataset_of_another_user.id)
