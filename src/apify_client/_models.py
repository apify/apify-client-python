...
#   timestamp: 2026-01-20T09:43:53+00:00
...
class SourceCodeFileFormat(Enum):
    BASE64 = 'BASE64'
    TEXT = 'TEXT'
...
class Server(BaseModel):
    url: Annotated[AnyUrl | None, Field(examples=['https://api.apify.com/v2'])] = None
...
class RunStats(BaseModel):
    ...
    mem_avg_bytes: Annotated[float | None, Field(alias='memAvgBytes', examples=[267874071.9], ge=0.0)] = None
...
class Profile(BaseModel):
    ...
    picture_url: Annotated[AnyUrl | None, Field(alias='pictureUrl', examples=['/img/anonymous_user_picture.png'])] = (
        None
    )
