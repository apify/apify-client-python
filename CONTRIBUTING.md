...
Our API documentation is generated from these docstrings using [griffe](https://mkdocstrings.github.io/griffe/) with additional post-processing. Markdown files in the `docs/` folder complement the autogenerated content. Final documentation is rendered using [Docusaurus](https://docusaurus.io/) and published to GitHub Pages.
